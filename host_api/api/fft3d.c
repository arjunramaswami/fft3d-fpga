...
static bool fft_size_changed = true;


// Function prototypes
bool init();
void cleanup();
static void init_program(char *data_path);
 ...
 *****************************************************************************/
void fpga_fft3d_sp_(int data_path_len, char *data_path, int direction, cmplx *din) {
 ...
 * \param   din : complex input/output single precision data pointer 
 *****************************************************************************/
void fpga_fft3d_dp_(int data_path_len, char *data_path, int direction, cmplx *din) {
